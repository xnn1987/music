...
public class Set_pwd_find extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentLayout(R.layout.set_pwd_find);
	...
	private void update(final Map<String, Object> param) throws BaseAppException {
		...
		new HttpResStrToAsync() {
			...
			public void handleMessage(Message msg) {
				if (msg.what == -1) {
					((BaseAppException) msg.obj).makeToast(Set_pwd_find.this);
				} else {
					// 提示
