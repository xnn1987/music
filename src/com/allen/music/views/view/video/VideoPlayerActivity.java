...
import com.allen.music.views.view.video.init.LibsChecker;
...
public class VideoPlayerActivity extends Activity implements OnCompletionListener, OnInfoListener {
	...
	public void onCreate(Bundle bundle) {
		...
		if (!LibsChecker.checkVitamioLibs(this, R.string.init_decoders)){
			Logger.d(getClass().getName(), "Vitamio解压解码包失败...");
			return;
		}
		...
		if (TextUtils.isEmpty(mPath)) {
			mPath = Environment.getExternalStorageDirectory() + "/MusicCloud/20131116103150.flv";
